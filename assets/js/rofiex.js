(function ($) {
  ...
  // Date Picker
  if ($(".rofiex-datepicker").length) {
    $('.rofiex-datepicker').datetimepicker({
      timepicker: false,
      datepicker: true,
      format: 'y-m-d',
      hours12: false,
  ...
  function rofiexSlickInit() {
    ...
    if (rofiexslickCarousel.length) {
      rofiexslickCarousel.each(function () {
        ...
        let rofiexslickCarousel = elm.slick(
          "object" === typeof options ? options : JSON.parse(options)
        );
      });
    }
    ...
    if (rofiexslickCarouselCounter.length) {
      rofiexslickCarouselCounter.each(function () {
        ...
        let updateSliderCounter = function (slick, currentIndex) {
          ...
          $(sliderCounter).html('<span class="rofiex-slick__counter__active">' + currentSlide + '</span>' + '' + '<span>' + slidesCount + '</span>')
        };
